...
import com.company.bmobkotlin.test.core.AbstractPasscodePage;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("com.company.bmobkotlin:id/passcode_field")).setText(passcode);
